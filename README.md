...
* Request
  * Method: POST
  * URL: /groups/:groupid/venues/create
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * URL: /groups/:groupid/events/create
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: POST
  * URL: /events/:eventid/images/create
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: GET
  * URL: /groups/groupid/members/request
  * Headers:
    * Content-Type: application/json
  * Body: none
...
* Request
  * Method: POST
  * URL: /groups/:groupid/membership/:membershipid
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: DELETE
  * URL: /groups/:groupid/memberships/:membershipid
  * Headers:
    * Content-Type: application/json
  * Body:
...
* Request
  * Method: GET
  * URL: /events/:eventid/attendees/request
  * Headers:
    * Content-Type: application/json
  * Body: none
...
* Request
  * Method: GET
  * URL: /events?parameter1=...&parameter2=...
  * Query Parameters
